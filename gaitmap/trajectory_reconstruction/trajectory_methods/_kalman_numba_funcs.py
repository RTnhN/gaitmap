...
from gaitmap.trajectory_reconstruction.orientation_methods._madgwick import (
    _madgwick_update,
)
...
def rts_kalman_update_series_fast(
...
def simple_navigation_equations(
    acc, gyro, orientation, position, velocity, sampling_rate_hz, _
):
...
@njit()
def madgwick_motion_update(
    acc, gyro, orientation, position, velocity, sampling_rate_hz, paras
):
